...
\dfn{Dot Product}{
	A \textbf{\ul{dot product}} of $u=\left\langle a_1,b_1 \right\rangle$ and $v=\left\langle a_2,b_2 \right\rangle$ is $u \cdot v=a_1a_2+b_1b_2$
}
...
Projection is represtented mathematically as $\proj_v(u)$, where $u$ is being projected onto $v$. $\proj_vu=(\frac{u \cdot v}{v^2})v$

\qs{}{Find $\proj_v(u)$ where $u=\left\langle 4,2 \right\rangle$ and $v=\left\langle 1,2 \right\rangle$}

\sol $\proj_v(u)=(\frac{u \cdot v}{v^2})v=\frac{(4 \cdot 1)+(2 \cdot 2)}{1^2+2^2}\left\langle 1,2 \right\rangle=\frac{4+4}{1+4}\left\langle 1,2 \right\rangle=\frac{8}{5}\left\langle 1,2 \right\rangle=\left\langle \frac{8}{5},\frac{16}{5} \right\rangle$
\begin{center}
	\begin{tikzpicture}
